...
#define APP_HEADER_LEN 16      //增加bin文件头长度

#define APP_UPDATE_FW_MAGICNUM_ADDR_OFFSET  0     //文件头magic num偏移
...
#define APP_UPDATE_MAGICNUM_HIGH    0x1122
#define APP_UPDATE_MAGICNUM_LOW     0x3344
